...
<section className="bg-white">
     ...
     {reviews.map(review => <div key={review.id} className="keen-slider__slide">
        ...
        <div className="flex md:gap-16 gap-8 justify-center my-4 text-5xl w-full"><button onClick={goToPrevSlide}><FaAngleLeft /></button>
      <button onClick={goToNextSlide}><FaAngleRight/></button></div>
